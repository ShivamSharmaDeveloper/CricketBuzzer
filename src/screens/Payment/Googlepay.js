...
const Googlepay = () => {
    ...
    const [phoneNumber, setPhoneNumber] = useState(userToken ? userToken?.googlepay : '');
    ...
    return (
        <SafeAreaView style={{ justifyContent: 'center' }}>
            ...
            >
                <Dialog.Title title="UPI Details!" titleStyle={{ color: '#333', }} />
                <Text style={{ color: '#333' }}>Your Googlepay upi id is saved!</Text>
                <Dialog.Actions>
                    <Dialog.Button
                        title="OK"
                        onPress={() => {
